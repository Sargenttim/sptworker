...
func SendWelcomeMessage(
	...
	if len(fields) > 0 {
		...
		if cmd.PremiumTier() == premium.None {
			formAnswersEmbed.SetFooter("Powered by spectrabot.ca", "https://spectrabot.ca/assets/img/logo.png")
		}
...
func BuildCustomEmbed(
	...
	if branding {
		e.SetFooter("Powered by spectrabot.ca", "https://spectrabot.ca/assets/img/logo.png")
